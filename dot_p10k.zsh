# Generated by Powerlevel10k configuration wizard on 2021-09-11 at 16:17 CST.
...
# lightest, angled separators, sharp heads, flat tails, 2 lines, dotted, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    kubeconfig               # example user-defined segment (see prompt_example function below)
  )
  ...
  function prompt_kubeconfig() {
    if [ "$KUBECONFIG" != "" ]; then
      if [ ! -f $KUBECONFIG ]; then
        ...
        CONFIG=$(echo $KUBECONFIG | sed -ne "s/.*\/\(.*\)/\1/p")
        p10k segment -f 200 -t "$CONFIG"
      fi
    fi
  }
